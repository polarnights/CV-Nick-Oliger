...
{
    \hfill
    \roundpic[yshift=-0.1cm]{4cm}{5cm}{images/portrait.png}
...
% left side %
{
    ...
    \csection{WORKING \& TEACHING EXPERIENCE}{\small
        \begin{itemize}
            % item 1 %
            \item \frcontent{Yandex.Zen}{Intern at product development team}{Worked on backend using Java}{October 2021 - Present}
            % item 2 %
...
% right side %
{
    ...
    \csection{OTHER HIGHLIGHTS}{\small
        \begin{itemize}
            \item {\footnotesize Currently working on IT startup with soulmates from Yandex.Taxi}
        \end{itemize}
    }
