...
% right side %
{
    \csection{AWARDS \& RECOGNITION}{\small
        \begin{itemize}
            % item 6 %
            \item \frcontent{Tinkoff scholarship awardee}{Academic track}{}{2022-2023}
            % item 1 %
    ...
    \csection{PROJECTS \& REPOS}{\small
        \begin{itemize}
            \item \frcontent{Summer practice '21 \clink{\href{https://github.com/polarnights/hse_weather_bot }{[HSE Weather Bot]}}}{Telegram bot showing current weather forecast using open API}{}{Python, TeleBot, git}
            % TODO: Replace with something more relevant
            \item \frcontent{LeetCode tasks \clink{\href{https://github.com/polarnights/LeetCode-Yandex}{[Algorithms and data structures]}}}{Repository with over 100 solved LeetCode problems}{}{C++}
        \end{itemize}
    }
